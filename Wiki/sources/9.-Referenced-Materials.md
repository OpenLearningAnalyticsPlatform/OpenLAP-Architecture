...
month = August,
year = {2015},
howpublished={\url{https://confluence.sakaiproject.org/display/LAI/Apereo+
  Learning+Analytics+Processor}}
}

@article{meier2009microsoft,
title={Microsoft application architecture guide},
author={Meier, JD and Hill, David and Homer, A and Jason, Taylor and Bansode, P
   and Wall, L and Boucher Jr, R and Bogawat, A},
year={2009},
...
month = August,
year = {2015},
howpublished={\url{https://www.apereo.org/communities/learning-analytics-
  initiative}}
}
...
title={Coupling and cohesion (towards a valid metrics suite for object-oriented
  analysis and design)},
...
title={Early alert of academically at-risk students: An open source analytics
  initiative},
author={Jayaprakash, Sandeep M and Moody, Erik W and Laur{\'\i}a, Eitel JM and
 Regan, James R and Baron, Joshua D},
...
title={Attention please!: learning analytics for visualization and
  recommendation},
author={Duval, Erik},
booktitle={Proceedings of the 1st International Conference on Learning
...
title={Complete web monitoring: watching your visitors, performance,
...
author={Lukarov, Vlatko and Chatti, Mohamed Amine and Th{\"u}s, Hendrik and
Kia, Fatemeh Salehian and Muslim, Arham and Greven, Christoph and Schroeder, Ulrik},
...
@article{cooper2013learning,
  title={Learning Analytics Interoperability-a survey of current literature
...
author={Johnson, Rod and Hoeller, Juergen and Donald, Keith and Sampaleanu,
  Colin and Harrop, Rob and Risberg, Thomas and Arendsen, Alef and Davison,
  Darren and Kopylenko, Dmitriy and Pollack, Mark and others},
journal={Interface},
volume={21},
year={2004}
}
